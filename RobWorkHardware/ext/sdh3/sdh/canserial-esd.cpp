...
/*!
  ...
  $Id: canserial-esd.cpp 6521 2011-03-08 12:36:01Z Osswald2 $
...
throw (cCANSerial_ESDException*)
{
    if ( pimpl->ntcan_handle == NTCAN_HANDLE(NTCAN_INVALID_HANDLE) )
    {
        ...
        dbg << "Opening ESD CAN net: " << net << ", baudrate: " << baudrate << ", id_read: 0x" << std::hex << id_read << ", id_write: 0x" << id_write << std::dec << "\n";
