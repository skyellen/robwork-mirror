     ...
     \internal
       ...
       \subsection sdhlibrary_cpp_sdh_demo_contact_grasping_details SVN related, detailed file specific information:
         ...
         \par SVN file revision:
           $Id: demo-contact-grasping.cpp 6265 2010-12-02 13:59:45Z Osswald2 $
...
char const* __version__   = "$Id: demo-contact-grasping.cpp 6265 2010-12-02 13:59:45Z Osswald2 $";
...
int main( int argc, char** argv )
{
    ...
    int unused_opt_ind;
    unused_opt_ind = options.Parse( argc, argv, __help__, "demo-contact-grasping", __version__, cSDH::GetLibraryName(), cSDH::GetLibraryRelease() );
