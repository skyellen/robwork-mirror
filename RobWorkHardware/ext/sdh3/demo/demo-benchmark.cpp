    ...
    \file
     ...
     \internal
       ...
       \subsection sdhlibrary_cpp_sdh_demo_benchmark_details SVN related, detailed file specific information:
         ...
         $LastChangedDate: 2011-02-23 18:57:55 +0100 (Mi, 23 Feb 2011) $
         \par SVN file revision:
           $Id: demo-benchmark.cpp 6485 2011-02-23 17:57:55Z Osswald2 $
...
char const* __help__      =
    ...
    "    > demo_benchmark -p 2  --dsaport=3\n"
    "     \n"
    "  - Make SDH connected to USB to RS232 converter 0 move:\n"
    "    > demo_benchmark --sdh_rs_device=/dev/ttyUSB0  --dsa_rs_device=/dev/ttyUSB1\n"
    "     \n"
    ...
    "    > demo_benchmark --port=2 --dsaport=3 -v\n";
char const* __author__    = "Dirk Osswald: dirk.osswald@de.schunk.com";
char const* __url__       = "http://www.schunk.com";
char const* __version__   = "$Id: demo-benchmark.cpp 6485 2011-02-23 17:57:55Z Osswald2 $";
...
int main( int argc, char** argv )
{
    ...
    int unused_opt_ind;
    unused_opt_ind = options.Parse( argc, argv, __help__, "demo_benchmark", __version__, cSDH::GetLibraryName(), cSDH::GetLibraryRelease() );
    ...
    {
        std::cerr << "demo_benchmark main(): An exception was caught: " << e->what() << "\n";
        delete e;
    }
}
//----------------------------------------------------------------------
