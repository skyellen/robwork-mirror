   ...
   \internal
     ...
     \subsection sdhlibrary_cpp_demo_dsa_cpp_details SVN related, detailed file specific information:
       ...
       \par SVN file revision:
         $Id: demo-dsa.cpp 6526 2011-03-09 10:55:11Z Osswald2 $
...
char const* __version__   = "$Id: demo-dsa.cpp 6526 2011-03-09 10:55:11Z Osswald2 $";
        ...
        if ( options.fullframe )
        {
            ...
            do
            {
                ...
                try
                {
                    ...
                    cout << ts;
                    if ( options.framerate > 0 )
                        cout << "Actual framerate=" << (1.0/last.Elapsed( now )) << "Hz nb_frames=" << nb_frames << " nb_errors=" << nb_errors << " (" << ((100.0*nb_errors)/nb_frames) << "%)\n";
                    last = now;
                    cout.flush();
                }
