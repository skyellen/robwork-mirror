  ...
  \internal
    ...
    \subsection sdhlibrary_cpp_sdh_cpp_details SVN related, detailed file specific information:
      ...
      \par SVN file revision:
        $Id: sdh.cpp 5000 2009-12-01 10:41:18Z Osswald2 $
    ...
    throw (cSDHLibraryException*)
{
    ...
    com->dbg.SetFlag( debug_level > 1 ); // set debug level of low level com interface to our own level-1
    comm_interface.Open( com );
...
void cSDH::OpenCAN_ESD( NTCAN_HANDLE _ntcan_handle, double _timeout, Int32 _id_read, Int32 _id_write )
    throw (cSDHLibraryException*)
{
#if WITH_ESD_CAN
    //---------------------
...
void cSDH::OpenCAN_PEAK( PCAN_HANDLE _handle, double _timeout, Int32 _id_read, Int32 _id_write )
    throw (cSDHLibraryException*)
{
#if WITH_PEAK_CAN
    //---------------------
