  ...
  \internal
    ...
    \subsection sdhlibrary_cpp_sdhserial_cpp_details SVN related, detailed file specific information:
      ...
      \par SVN file revision:
        $Id: sdhserial.cpp 5022 2009-12-04 16:05:53Z Osswald2 $
    ...
    throw (cSDHLibraryException*)
{
    ...
    // FIXME: !!! (This is really a mess but we cannot get around it since the SDH firmware sends kinky data and we cannot change the firmware of SDH 003)
    SyncUnknown();
    //cdbg << "sleeping 3s\n";
    SleepSec(3);
    //cdbg << "ok\n";
    ...
    throw (cSDHLibraryException*)
{
    ...
    //---------------------
    // settings for sequential/non-sequential:
    int nb_lines_total = 5;
    int nb_lines = sequ ? nb_lines_total : 3;
    //---------------------
