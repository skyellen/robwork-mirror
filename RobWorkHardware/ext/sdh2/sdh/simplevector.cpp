  ...
  \internal
    ...
    \subsection sdhlibrary_cpp_simplevector_cpp_details SVN related, detailed file specific information:
      ...
      \par SVN file revision:
        $Id: simplevector.cpp 3659 2008-10-08 08:48:38Z Osswald2 $
...
cSimpleVector::cSimpleVector( int _nb_values, char const* str )
    throw (cSimpleVectorException*)
{
    FromString( _nb_values, 0, str );
}
//-----------------------------------------------------------------


cSimpleVector::cSimpleVector( int _nb_values, int start_index, char const* str )
    throw (cSimpleVectorException*)
{
    FromString( _nb_values, start_index, str );
}
//-----------------------------------------------------------------
