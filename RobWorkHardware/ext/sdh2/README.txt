NOTICE: THESE SOURCES HAVE BEEN MODIFIED BY ROBWORK SUCH THAT 
ONLY THE CMAKE BUILD SYSTEM IS WORKING. PLEASE MAKE A FOLDER build/release
FROM WHERE YOU USE CMAKE LIKE: cmake ../..
