     ...
     \internal
       ...
       \subsection dhlibrary_cpp_sdh_dsaboost_h_details SVN related, detailed file specific information:
         ...
         \par SVN file revision:
           $Id: dsaboost.h 4932 2009-11-02 08:20:24Z Osswald2 $
...
public:
    ...
    /*!
     * CTOR: start an updater thread for the connected tactile sensor \a ts
     *
     ...
     * \param error_threshold - the number of errors that causes a "reset" of the connection to the remote DSA:
