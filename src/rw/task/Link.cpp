...
rw::interpolator::Pose6dStraightSegment CircularToolConstraint::Interpolator(rw::math::Transform3D<> &a, rw::math::Transform3D<> &b)
{
	return rw::interpolator::Pose6dStraightSegment(a, rw::math::VelocityScrew6D<>(b.P()-a.P(),inverse(a.R())*b.R()));
...
rw::interpolator::StraightSegment LinearJointConstraint::Interpolator(rw::math::Q &a, rw::math::Q &b)
{
