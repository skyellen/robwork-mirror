...
bool DSACON32::StopDataAcquisition(rwlibs::io::SerialPort *sPort)
{
...
bool DSACON32::QueryControllerConfig(rwlibs::io::SerialPort *sPort, ControllerConfig *cConfig)
{
    unsigned char data[6];
...
bool DSACON32::QuerySensorConfig(rwlibs::io::SerialPort *sPort, SensorConfig *sConfig)
{
    unsigned char data[6];
...
bool DSACON32::QueryMatrixConfig(rwlibs::io::SerialPort *sPort, unsigned char matrixNum, MatrixConfig *mConfig)
{
...
bool DSACON32::ReadMatrixMask(rwlibs::io::SerialPort *sPort, unsigned char maskType,
...
bool DSACON32::ReadDescriptorString(rwlibs::io::SerialPort *sPort, unsigned char descrType,
...
bool DSACON32::ReadAck(unsigned char cmdId, unsigned int timeout, rwlibs::io::SerialPort *sPort, void* answer)
{
	unsigned char id;
	unsigned short payloadSize;
	unsigned char header[3];
...
bool DSACON32::ReadHeader(unsigned char &id, unsigned short &payloadSize, unsigned char *header,
						  unsigned int timeout, rwlibs::io::SerialPort *sPort)
{
    // Search for preamble
	do
	{
