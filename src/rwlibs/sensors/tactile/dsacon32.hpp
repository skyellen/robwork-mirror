...
namespace sensors {
    ...
    private:
		...
		static bool StopDataAcquisition(rwlibs::io::SerialPort *sPort);
        static bool QueryControllerConfig(rwlibs::io::SerialPort *sPort, ControllerConfig *cConfig);
        static bool QuerySensorConfig(rwlibs::io::SerialPort *sPort, SensorConfig *sConfig);
		static bool QueryMatrixConfig(rwlibs::io::SerialPort *sPort, unsigned char matrixNum,
		...
		static bool ReadMatrixMask(rwlibs::io::SerialPort *sPort, unsigned char maskType,
			                       unsigned char matrixNum, TactileMaskMatrix *mat);
		static bool ReadDescriptorString(rwlibs::io::SerialPort *sPort, unsigned char descrType,
			                             unsigned char matrixNum, std::string *str);
        static bool ReadAck(unsigned char cmdId, unsigned int timeout,
			                rwlibs::io::SerialPort *sPort, void* answer=NULL);
        ...
        static void SendBlocking(unsigned char* data, int len, unsigned char id,
        						int timeout, rwlibs::io::SerialPort *sPort)
		{
