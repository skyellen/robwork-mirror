...
namespace rwlibs { namespace algorithms {
    ...
    /**
     * @brief The JTagMarker class defines a visual 2d quadrant barcode marker.
     *
     * It is defined as a nxn matrix of black and white equally sized quadrants,
     * where the inner matrix (n-2)x(n-2) defines the orientation and
     * identification of the marker. The inner matrix starts at (1,1) where the
     * outer starts at (0,0). The outer matrix is a boundary and this boundary
     * is completely black.
     * 
    ...
    public:
        ...
        /**
         * @brief Parses a (n-2) x (n-2) size matrix of probabilities to a
         * JTagMarker.
         *
         ...
         */
        static bool parseMatrix(
            boost::numeric::ublas::matrix<double> valueMatrix,
            JTagMarker &marker);
