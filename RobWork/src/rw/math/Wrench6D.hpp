...
namespace serialization {
    void write(const rw::math::Wrench6D<double>& tmp, rw::common::OutputArchive& oar, const std::string& id);
    void write(const rw::math::Wrench6D<float>& tmp, rw::common::OutputArchive& oar, const std::string& id);
    void read(rw::math::Wrench6D<double>& tmp, rw::common::InputArchive& iar, const std::string& id);
    void read(rw::math::Wrench6D<float>& tmp, rw::common::InputArchive& iar, const std::string& id);
}}} // end namespaces
