...
namespace rw { namespace graphics {
    ...
    public:
         ...
         * otherwise
         */
        static Model3D::Ptr getModel(const std::string& str, const std::string& name);
         ...
         */
        static Model3D::Ptr loadModel(const std::string &filename, const std::string& name);
         ...
         */
        static Model3D::Ptr constructFromGeometry(const std::string& str, const std::string& name, bool useCache=false);

    private:
        typedef rw::common::FileCache<std::string, Model3D, std::string> FactoryCache;
