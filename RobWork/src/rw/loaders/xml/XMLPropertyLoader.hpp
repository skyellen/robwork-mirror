...
public:
	 ...
	 *
	 * If the XMLPropertyLoader is used outside main (as a part of global initialization/destruction), the Initializer
	 ...
	 * be necessary to specify the initializer explicitly if XMLPropertyLoader is to be used in local static
