...
#ifndef RW_GEOMETRY_TRIDEVILLER_HPP_
#define RW_GEOMETRY_TRIDEVILLER_HPP_
...
namespace geometry {
     ...
     * code is strongly inspired/copied from Opcode 1.3 Pierre Terdiman 2001.
     *
     *
     *
     */
    template<class T=double>
    class TriTriOverlapMoller {
    public:
    ...
    template<class T>
    bool TRIDeviller<T>::inCollision(const rw::geometry::Triangle<value_type>& P,
