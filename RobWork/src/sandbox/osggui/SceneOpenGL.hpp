...
namespace rwlibs { namespace drawable {
    ...
    /**
     * @brief Helps with Visualizing a Workcell. SimpleGLScene is OpenGL specific
     */
    class SimpleGLScene {
    public:
        /**
    ...
    private:
        ...
        boost::mutex _mutex;
    private:
        SimpleGLScene(const SimpleGLScene&);
        SimpleGLScene& operator=(const SimpleGLScene&);
    };
