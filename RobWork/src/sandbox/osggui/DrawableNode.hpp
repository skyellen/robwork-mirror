...
#ifndef RWLIBS_DRAWABLE_DRAWABLENODE_HPP
#define RWLIBS_DRAWABLE_DRAWABLENODE_HPP
...
namespace rwlibs { namespace drawable {
    ...
    public:
    	...
    	typedef enum{Physical=1, //! A physical object in the scene
    				 ...
    				 DrawableNodeObject=4, //! An object that is "just" a drawable
         ...
         */
        virtual void draw(const RenderInfo& info) const = 0;
