...
#ifndef RWLIBS_MATHEMATICA_EVALUATEPACKET_HPP_
#define RWLIBS_MATHEMATICA_EVALUATEPACKET_HPP_

/**
 * @file EvaluatePacket.hpp
 *
...
//! @{
//! @brief A Mathematica WSTP %EvaluatePacket.
...
#endif /* RWLIBS_MATHEMATICA_EVALUATEPACKET_HPP_ */
