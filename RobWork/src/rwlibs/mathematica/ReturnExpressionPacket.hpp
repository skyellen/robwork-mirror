...
#ifndef RWLIBS_MATHEMATICA_RETURNEXPRESSIONPACKET_HPP_
#define RWLIBS_MATHEMATICA_RETURNEXPRESSIONPACKET_HPP_

/**
 * @file ReturnExpressionPacket.hpp
 *
 * \copydoc rwlibs::mathematica::ReturnExpressionPacket
 */
...
public:
	...
	typedef rw::common::Ptr<ReturnExpressionPacket> Ptr;
	 ...
	 * @param expression [in] the expression.
	 */
	ReturnExpressionPacket(rw::common::Ptr<const Mathematica::Expression> expression);
