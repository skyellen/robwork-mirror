...
namespace rwlibs { namespace opengl {
	 ...
	 * \endcode
	 */
    class Drawable: public DrawableNode {
    public:
         ...
         */
        virtual void draw(const RenderInfo& info) const;
        ...
        void addRender( Render::Ptr render ){
    ...
    protected:
         ...
         * drawable
         */
    	std::vector<rw::common::Ptr<Render> > _renders;

        /**
         * @brief drawType specified how the Drawable should be visualized
         */
        DrawableNode::DrawType _drawType;
