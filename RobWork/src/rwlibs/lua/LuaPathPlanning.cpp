/*
** Lua binding: LuaCommon
** Generated automatically by tolua++-1.0.92 on 10/12/10 15:56:25.
*/
...
/* Exported function */
TOLUA_API int  tolua_LuaCommon_open (lua_State* tolua_S);
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_StopCriteria_stopAfter00
static int tolua_LuaCommon_rwlibs_lua_StopCriteria_stopAfter00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_StopCriteria_stopNever00
static int tolua_LuaCommon_rwlibs_lua_StopCriteria_stopNever00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_StopCriteria_stopNow00
static int tolua_LuaCommon_rwlibs_lua_StopCriteria_stopNow00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_StopCriteria_stopByFlag00
static int tolua_LuaCommon_rwlibs_lua_StopCriteria_stopByFlag00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_StopCriteria_stopCnt00
static int tolua_LuaCommon_rwlibs_lua_StopCriteria_stopCnt00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_StopCriteria_stopEither00
static int tolua_LuaCommon_rwlibs_lua_StopCriteria_stopEither00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_QToQPlanner_query00
static int tolua_LuaCommon_rwlibs_lua_QToQPlanner_query00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
/* method: query of class  rwlibs::lua::QToQPlanner */
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_QToQPlanner_query01
static int tolua_LuaCommon_rwlibs_lua_QToQPlanner_query01(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"rwlibs::lua::QToQPlanner",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_LuaCommon_rwlibs_lua_QToQPlanner_query00(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE

/* method: query of class  rwlibs::lua::QToQPlanner */
#ifndef TOLUA_DISABLE_tolua_LuaCommon_rwlibs_lua_QToQPlanner_query02
static int tolua_LuaCommon_rwlibs_lua_QToQPlanner_query02(lua_State* tolua_S)
{
 tolua_Error tolua_err;
 if (
     !tolua_isusertype(tolua_S,1,"rwlibs::lua::QToQPlanner",0,&tolua_err) ||
 ...
 return 1;
tolua_lerror:
 return tolua_LuaCommon_rwlibs_lua_QToQPlanner_query01(tolua_S);
}
#endif //#ifndef TOLUA_DISABLE
...
TOLUA_API int tolua_LuaCommon_open (lua_State* tolua_S)
{
  ...
  tolua_beginmodule(tolua_S,"rwlibs");
   ...
   tolua_beginmodule(tolua_S,"lua");
    ...
    tolua_beginmodule(tolua_S,"StopCriteria");
     tolua_function(tolua_S,"stopAfter",tolua_LuaCommon_rwlibs_lua_StopCriteria_stopAfter00);
     tolua_function(tolua_S,"stopNever",tolua_LuaCommon_rwlibs_lua_StopCriteria_stopNever00);
     tolua_function(tolua_S,"stopNow",tolua_LuaCommon_rwlibs_lua_StopCriteria_stopNow00);
     tolua_function(tolua_S,"stopByFlag",tolua_LuaCommon_rwlibs_lua_StopCriteria_stopByFlag00);
     tolua_function(tolua_S,"stopCnt",tolua_LuaCommon_rwlibs_lua_StopCriteria_stopCnt00);
     tolua_function(tolua_S,"stopEither",tolua_LuaCommon_rwlibs_lua_StopCriteria_stopEither00);
    tolua_endmodule(tolua_S);
    tolua_cclass(tolua_S,"QToQPlanner","rwlibs::lua::QToQPlanner","",NULL);
    tolua_beginmodule(tolua_S,"QToQPlanner");
     tolua_function(tolua_S,"query",tolua_LuaCommon_rwlibs_lua_QToQPlanner_query00);
     tolua_function(tolua_S,"query",tolua_LuaCommon_rwlibs_lua_QToQPlanner_query01);
     tolua_function(tolua_S,"query",tolua_LuaCommon_rwlibs_lua_QToQPlanner_query02);
    tolua_endmodule(tolua_S);
 ...
 TOLUA_API int luaopen_LuaCommon (lua_State* tolua_S) {
 return tolua_LuaCommon_open(tolua_S);
};
#endif
