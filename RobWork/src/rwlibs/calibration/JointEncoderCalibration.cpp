...
namespace {
	...
	public:
		virtual ~EncoderTauFunction() {}
		virtual double f(double q) { return -sin(q); }
	};
	class EncoderSigmaFunction: public rw::math::Function<> {
	public:
		virtual ~EncoderSigmaFunction() {}
		virtual double f(double q) { return -cos(q); }
	};
}
