...
#include <rw/iksolvers/GeneralSolver.hpp>
...
void ParallelDeviceTest()
{
    ...
    { // test of a HexaPod from microbotics
		...
		//std::cout << "Pose 2: "<< hexapod.baseTend(state) << std::endl;
        ...
        std::cout << "new configuration: " << std::endl;
        hexapod.setQ(q,state);
		std::cout << "Pose 3: "<< hexapod.baseTend(state) << std::endl;
        ...
        std::cout << "new configuration: " << std::endl;
        hexapod.setQ(q,state);
		std::cout << "Pose 4: "<< hexapod.baseTend(state) << std::endl;
