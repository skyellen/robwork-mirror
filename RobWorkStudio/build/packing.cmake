...
ELSEIF(MINGW)
	SET(SUFFIX "MinGW")
ELSEIF(MSVC)
	SET(SUFFIX "MSVC${MSVC_VERSION}-${ARCH}")
ELSE()
	# Trouble
	SET(SUFFIX "")
ENDIF()
...
WriteRegExpandStr HKCU Environment PATH \\\"$INSTDIR\\\\bin;$R0\\\"
WriteRegExpandStr HKCU Environment RWS_ROOT $INSTDIR"
	)
# TODO: Uninstall RWS_ROOT\bin from PATH also
