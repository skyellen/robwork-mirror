...
ENDIF ()
MESSAGE(STATUS "RobWorkStudio: Build configuration: ${CMAKE_BUILD_TYPE}")
...
SET(RWS_CMAKE_RUNTIME_OUTPUT_DIRECTORY "${ROOT}/bin/${CMAKE_BUILD_TYPE}" )
SET(RWS_CMAKE_LIBRARY_OUTPUT_DIRECTORY "${ROOT}/libs/${CMAKE_BUILD_TYPE}" )
SET(RWS_CMAKE_ARCHIVE_OUTPUT_DIRECTORY "${ROOT}/libs/${CMAKE_BUILD_TYPE}" )
