...
#ifndef RWSIMLIBS_RWPE_RWPEINTEGRATORHEUN_HPP_
#define RWSIMLIBS_RWPE_RWPEINTEGRATORHEUN_HPP_

/**
 * @file RWPEIntegratorHeun.hpp
 *
 * \copydoc rwsimlibs::rwpe::RWPEIntegratorHeun
 */
 ...
 */
class RWPEIntegratorHeun: public RWPEIntegrator {
public:
	 ...
	 */
	RWPEIntegratorHeun(const RWPEBodyDynamic* body);

	//! @brief Destructor
	virtual ~RWPEIntegratorHeun();
...
private:
	const RWPEIntegrator* const _euler;
};
//! @}
} /* namespace rwpe */
} /* namespace rwsimlibs */
#endif /* RWSIMLIBS_RWPE_RWPEINTEGRATORHEUN_HPP_ */
