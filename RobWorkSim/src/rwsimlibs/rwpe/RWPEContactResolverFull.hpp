...
#ifndef RWSIMLIBS_RWPE_RWPECONTACTRESOLVERFULL_HPP_
#define RWSIMLIBS_RWPE_RWPECONTACTRESOLVERFULL_HPP_

/**
 * @file RWPEContactResolverFull.hpp
 *
 * \copydoc rwsimlibs::rwpe::RWPEContactResolverFull
 */
 ...
 */
class RWPEContactResolverFull: public RWPEContactResolver {
public:
	/**
	 * @brief Default constructor.
	 * @note Using resolve() will throw an exception when resolver is created like this.
	 */
	RWPEContactResolverFull();

	/**
	 * @brief Construct new solver.
     * @param solver [in] a pointer to the solver to use.
	 */
	RWPEContactResolverFull(const RWPEConstraintSolver* solver);

	//! @brief Destructor.
	virtual ~RWPEContactResolverFull();
...
#endif /* RWSIMLIBS_RWPE_RWPECONTACTRESOLVERFULL_HPP_ */
