...
void TNTContactResolverHeuristic::solve(const std::vector<TNTContact*>& persistentContacts, double h, const State &rwstate, TNTIslandState &tntstate) const {
	if (_solver == NULL)
	...
	_solver->saveSolution(solution,tntstate);
}
