...
#ifndef RWSIMLIBS_TNTPHYSICS_TNTRESTITUTIONMODEL_HPP_
#define RWSIMLIBS_TNTPHYSICS_TNTRESTITUTIONMODEL_HPP_

/**
 * @file TNTRestitutionModel.hpp
 *
 * \copydoc rwsimlibs::tntphysics::TNTRestitutionModel
 */
...
public:
	 ...
	 */
	virtual const TNTRestitutionModel* withProperties(const rw::common::PropertyMap &map) const = 0;
	 ...
	 * @extensionpoint{rwsimlibs::tntphysics::TNTRestitutionModel::Factory,rwsimlibs::tntphysics::TNTRestitutionModel,rwsimlibs.tntphysics.TNTRestitutionModel}
	 */

	/**
	 * @brief A factory for a TNTRestitutionModel. This factory also defines an ExtensionPoint.
	 *
	 * By default the factory provides the following TNTRestitutionModel type:
	 *  - Newton - TNTRestitutionModelNewton
	 */
	class Factory: public rw::common::ExtensionPoint<TNTRestitutionModel> {
	public:
		/**
		 ...
		 * @return a pointer to a new TNTRestitutionModel owned by the caller (can return NULL if properties are not as expected).
		 */
		static const TNTRestitutionModel* makeModel(const std::string& model, const rw::common::PropertyMap &properties);
...
#endif /* RWSIMLIBS_TNTPHYSICS_TNTRESTITUTIONMODEL_HPP_ */
