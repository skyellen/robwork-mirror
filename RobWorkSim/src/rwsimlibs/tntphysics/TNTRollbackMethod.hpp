...
#ifndef RWSIMLIBS_TNTPHYSICS_TNTROLLBACKMETHOD_HPP_
#define RWSIMLIBS_TNTPHYSICS_TNTROLLBACKMETHOD_HPP_

/**
 * @file TNTRollbackMethod.hpp
 *
 * \copydoc rwsimlibs::tntphysics::TNTRollbackMethod
 */
 ...
 */
class TNTRollbackMethod {
public:
    //! Smart pointer type of TNTRollbackMethod
    typedef rw::common::Ptr<const TNTRollbackMethod> Ptr;
	 ...
	 * @extensionpoint{rwsimlibs::tntphysics::TNTRollbackMethod::Factory,rwsimlibs::tntphysics::TNTRollbackMethod,rwsimlibs.tntphysics.TNTRollbackMethod}
	 */

	/**
	 * @brief A factory for a TNTRollbackMethod. This factory also defines an ExtensionPoint.
	 *
	 * By default the factory provides the following TNTRollbackMethod type:
	 *  - Ridder - TNTRollbackMethodRidder
	 */
	class Factory: public rw::common::ExtensionPoint<TNTRollbackMethod> {
	public:
		/**
		 ...
		 * @param method [in] the name of the method.
		 * @return a pointer to a new TNTRollbackMethod.
		 */
		static TNTRollbackMethod::Ptr makeMethod(const std::string& method);
...
#endif /* RWSIMLIBS_TNTPHYSICS_TNTROLLBACKMETHOD_HPP_ */
