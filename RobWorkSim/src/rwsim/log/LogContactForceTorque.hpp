 ...
 */
class LogContactForceTorque: public SimulatorLogEntry {
public:
	 ...
	 * @param i [in] the contact to get wrench for.
	 * @return the wrench.
	 */
	 ...
	 * @param i [in] the contact to set wrench for.
	 * @param wrenchA [in] the wrench acting in the contact at the first body.
	 * @param wrenchB [in] the wrench acting in the contact at the second body.
	 */
