...
- Changelog and release notes can be found here \ref page_rwsim_release_notes

\section sec_rwsim_index_manual Manuals and tutorials
- \ref page_rwsim_manual

\section sec_rwsim_index_download Download

- Download \b RobWork, \b RobWorkStudio and \b RobWorkSim from the <a href="http://www.robwork.dk">RobWork homepage</a>.
...
\section sec_rwsim_index_license License

- RobWorkSim is distributed under the
\ref page_rwsim_license "Apache License, Version 2.0", which is the same as \b RobWork
