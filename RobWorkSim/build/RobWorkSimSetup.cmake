...
OPTION(RWSIM_USE_LUA "Set when you want to use lua!" ${RWS_USE_LUA})
IF( RWSIM_USE_LUA )
    ...
    ELSE ()
        MESSAGE(SEND_ERROR "RobWorkSim: Lua DISABLED! - RobWork is NOT compiled with Lua support! Set RWSIM_USE_LUA=OFF")
        SET(RWSIM_HAVE_LUA False)    
    ENDIF ()
ELSE ()
